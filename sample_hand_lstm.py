...
lstm_classifier = ActionClassificationLSTM.load_from_checkpoint("lightning_logs/version_0/checkpoints/epoch=20-step=671.ckpt")
    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                # 描画
                debug_image,hand_point = draw_landmarks(debug_image, cx, cy,
                                           hand_landmarks, handedness)
                # debug_image = draw_bounding_rect(use_brect, debug_image, brect)
                features = []
                if len(hand_point) != 0:
                    b = copy.deepcopy(hand_point)
                    ...
                    if len(buffer_window) < WINDOW_SIZE:  # WINDOW_SIZE = 32
                        ...
                        print("Label detected ", a)
                else:
                     continue
        cv.putText(debug_image, "Action:"+a, (10, 60), cv.FONT_HERSHEY_SIMPLEX, 1.0, (0, 0, 255), 2, cv.LINE_AA)
...
def draw_landmarks(image, cx, cy, landmarks, handedness):
    ...
    for index, landmark in enumerate(landmarks.landmark):
        ...
        #21个点
        if index == 0:  # 手首1 (landmark_x, landmark_y)为圆心
    ...
    # print(landmark_point) [(366, 529), (405, 530), (438, 513), (459, 490), (475, 465), (434, 463), (463, 438),....]
